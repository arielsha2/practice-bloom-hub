...
השתמש רק במה שעלה בפועל בשיחה ובמשוב שניתן בשלב 4. אל תמציא. אם פרט חסר — מחרוזת ריקה או null לפי הסוג.`,
  ...
  "practice-diagnosis": {
    ...
    system: `אתה מנסח, בקול של אליענה — המנטורית של "קליניקה בדרך" — את תוצאת שיחת "האבחון" שהתקיימה זה עתה בין הבוט למטפל/ת פסיכותרפיסט/ית. השיחה עברה 4 שלבים: פתיחה, חקירה אדפטיבית (מיקום קישור שבור במשפך + השערת מנגנון התנהגותי), אבחון במבנה "אהא", והמלצת צעד הבא.
