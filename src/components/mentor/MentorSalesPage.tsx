...
const PAYMENT_URL_EN = "https://www.paypal.com/ncp/payment/TLJZ4QDGZCDWN";
...
const COPY: any = {
  he: {
    badge: "גרסת בטא ",
    hero: {
      title: "את לא בלתי־נראית כי את לא טובה מספיק",
      subtitle: ["את בלתי־נראית כי אף אחד לא יודע", "מה לומר עלייך כשמישהו שואל למי להפנות."],
      body: "המנטור עוזר לך לנסח מי את, ולהיות השם שעולה בראש כשמישהו כבר חושב למי להפנות — באותנטיות, בביטחון, ובלי להרגיש מכירתי.",
    ...
    personas: {
      ...
      list: [
        "יש מי שמוריד מחירים כי לא בטוח שמגיע לו יותר.",
        "יש מי שיודע שיש לו מה להציע, אבל כשצריך להסביר את זה למישהו, המילים נתקעות.",
        'יש מי שמנסה "לעשות שיווק", ומרגיש שזה לא הוא.',
        "יש מי שמחכה שהקליניקה תגדל מעצמה. שאם הטיפול שלו יהיה ממש מעולה, השמועה תתפשט מאליה.",
        "יש מי שחוזר שוב ושוב לעבודה הציבורית, למרות השעות הרבות והמשכורת הלא מוצדקת, כי זה מייאש לקדם את הקליניקה לבד.",
        "יש מי שכבר ניסה. קנה ספרים, קורסים, קרא, הבין. ואז לא עשה כלום עם זה. כי ידע לבד לא מזיז אנשים.",
        "יש מי שיודע שהוא צריך ליווי אישי, אבל תוכנית ליווי איכותית עולה אלפי שקלים, וכרגע זה לא אפשרי.",
      ],
    ...
    beta: {
      ...
      exclusive: "בלעדי לגרסה הנוכחית",
      seats: "לזמן מוגבל בלבד",
      p1: "יש לך אפשרות לקבל את המנטור בגירסת הבטא, בתנאים מיוחדים שלא יחזרו.",
