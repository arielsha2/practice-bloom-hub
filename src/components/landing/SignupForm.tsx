...
export function SignupForm() {
  ...
  return (
    <section id="signup" className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl mx-auto">
          {/* Form card */}
          <div className={`bg-card rounded-3xl shadow-elevated border border-border p-8 md:p-12 ${isRTL ? 'text-right' : ''}`}>
            {/* Header */}
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-warm mb-6">
