...
const FAQ_ITEMS = [
  {
    ...
    a: "על שפת הקליניקה" היא פלטפורה וגישה שיווקית מיוחדת למטפלים שהקימו ד"ר אריאל ואליענה שפירא. הגישה מתייחדת בהבנה שחייבת להיות הלימה בין העולם הפנימי של המטפל, הביטחון שלו בערך ובטיפול שהוא נותן והמעשים והצעדיים השיווקים והעיסקיים. ללא הלימה תתעכב העשייה או לחילופין תיעשה באופן מנותק ולא מחובר ואותנטי"',
  },
  {
