...
const FAQ_ITEMS = [
  {
    ...
    a: '"על שפת הקליניקה" היא הגישה הייחודית של ד"ר אריאל שפירא שמתמקדת במצב הפנימי של המטפל לפני הכלים — הנחת היסוד היא שמטפל שיודע מי הוא ומה הייחודיות שלו, יצליח לבנות קליניקה רווחית באופן אותנטי, ללא טריקים שיווקיים.',
  },
  {
