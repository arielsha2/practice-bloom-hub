          ...
          <div className={`flex flex-col ${isRTL ? 'text-right lg:order-2' : 'lg:order-1'}`}>
            ...
            >
              ...
              <span className="text-muted-foreground text-sm">
                {isRTL ? 'הצטרפו ל-500+ מטפלים' : 'Join 500+ therapists'}
              </span>
            </motion.div>
            ...
            <div className="relative w-full aspect-square max-w-lg mx-auto">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-foreground">{isRTL ? 'קהילה תומכת' : 'Supportive Community'}</p>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">{isRTL ? 'הכרה מקצועית' : 'Professional recognition'}</p>
                  </div>
                </div>
              </motion.div>
