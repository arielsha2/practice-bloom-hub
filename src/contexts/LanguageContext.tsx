...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "auth.signupSuccessPasswordless": "Check your email! We sent you a link to set your password.",
  ...
  he: {
    ...
    "auth.signupSuccessPasswordless": "בדקו את האימייל! שלחנו לכם קישור להגדרת סיסמה.",
