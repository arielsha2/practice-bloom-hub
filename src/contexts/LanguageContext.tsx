...
const translations: Record<Language, Record<string, string>> = {
  ...
  he: {
    ...
    "auth.signupSuccessPasswordless": "שלחנו לכם קישור כניסה למייל. לחיצה אחת ואתם בפנים — בלי סיסמה.",
    "auth.signupError": "שגיאה ביצירת החשבון. נסו שוב.",
    "auth.signupSubtitlePasswordless": "הזינו את האימייל שלכם — נשלח לכם קישור כניסה בלחיצה אחת",
    "auth.signupHelperText": "אין צורך לבחור סיסמה. תקבלו קישור מאובטח למייל ותכנסו ישר פנימה.",
